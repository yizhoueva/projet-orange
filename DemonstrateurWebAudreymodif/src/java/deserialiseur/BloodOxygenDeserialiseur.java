 ...
 * @author Romeo
 */
public class BloodOxygenDeserialiseur implements JsonDeserializer<BloodOxygen> {

    @Override
    public BloodOxygen deserialize(JsonElement json, Type type, JsonDeserializationContext jdc) throws JsonParseException {
